...
import {
  View, Text, TouchableOpacity, ScrollView, RefreshControl, Share, StyleSheet,
} from "react-native";
...
const makeStyles = () => StyleSheet.create({
  ...
  dayLabel: { fontSize: FontSize.sm, fontWeight: "600", color: Colors.textSecondary },
  hoursValue: { fontSize: FontSize.sm, color: Colors.text },
  muted: { fontSize: FontSize.sm, color: Colors.textMuted, fontStyle: "italic" },
  actions: {
    flexDirection: "row",
    gap: Spacing.sm,
    marginHorizontal: Spacing.lg,
  ...
  secondaryBtnText: { fontSize: FontSize.sm, fontWeight: "700", color: Colors.purple },
  signOutBtn: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
