...
const makeStyles = () => {
  const s = useThemeStyles(() => ({
    ...
    bubble: { maxWidth: "78%" as any, padding: Spacing.md, borderRadius: BorderRadius.lg },
    ...
    bubbleMeta: { flexDirection: "row" as const, alignItems: "center" as const, gap: 4, marginTop: 4 },
